...
#SBATCH --mem=100GB
#SBATCH --job-name="roaryphyloggroup1"
...
query_pan_genome -a difference --input_set_one 4B7.gff,8B3.gff,3M6.gff,6M2.gff,5B2.gff,5B8.gff --input_set_two 9B2.gff,9B6.gff,8B4.gff,8B9.gff,10M9.gff,8M5.gff,8B6.gff,3B9.gff,5B9.gff,1B5.gff,4B6.gff,4M3.gff
